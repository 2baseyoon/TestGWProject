	...
	function setGridHeader(){
		// 진행함
		 var headerData1 =[{key:'chk', label:'chk', width:'20', align:'center', formatter:'checkbox'},
             ...
             {key:'InitiatedDate', label:'<spring:message code="Cache.lbl_RepeateDate"/>' + Common.getSession("UR_TimeZoneDisplay"),  width:'80', align:'center', sort:'desc',
           	  formatter:function () {
       			  return getStringDateToString("yyyy.MM.dd HH:mm:ss",this.item.InitiatedDate);
       	  	   }
             }];	
	     ...
	     var headerData2 =[{key:'chk', label:'chk', width:'20', align:'center', formatter:'checkbox'},
             ...
             {key:'CompletedDate', label:'<spring:message code="Cache.lbl_RepeateDate"/>' + Common.getSession("UR_TimeZoneDisplay"),  width:'80', align:'center', sort:'desc',
           	  formatter:function () {
       			  return getStringDateToString("yyyy.MM.dd HH:mm:ss",this.item.CompletedDate);
       	  	   }
             }];	
