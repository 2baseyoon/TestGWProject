...
<!-- onboarding start -->
<div class="ui_onboarding" data-name="approval" style="display:none;">
    <div class="step step_intro step_active">
        <div class="card_intro">
            ...
            <div class="banner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/bg_intro.png" alt="전자결재 인트로" /></div>
            <div class="action">
        ...
        <button type="button" class="guide_close" onclick="closeGuide('approval', true);"><span>가이드 페이지를 보지 않겠습니다.</span></button>
    </div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step1.png" alt="전자결재 가이드1" /></div></div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step2.png" alt="전자결재 가이드2" /></div></div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step3.png" alt="전자결재 가이드3" /></div></div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step4.png" alt="전자결재 가이드4" /></div></div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step5.png" alt="전자결재 가이드5" /></div></div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step6.png" alt="전자결재 가이드6" /></div></div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step7.png" alt="전자결재 가이드7" /></div></div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step8.png" alt="전자결재 가이드8" /></div></div>
    <div class="step"><div class="inner"><img src="<%=cssPath%>/covicore/resources/images/onboarding/approval/step9.png" alt="전자결재 가이드9" /></div></div>
...
<script type="text/javascript">
	...
	if ('<%=RedisDataUtil.getBaseConfig("UseWebGuidePopup")%>' == "Y" && !guideSession.split(",").includes("approval")) {
