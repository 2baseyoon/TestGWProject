	...
	<div class="apprvalContent">
		<div class="boradTopCont apprvalTopCont">
			...
			<p style = "float: right; padding: 20px 0 0; margin-right: 190px; font-size:12px;">
    	        <img src="/approval/resources/images/Approval/ico_comment.gif" alt="" title="<spring:message code='Cache.lbl_apv_comment' />" class="ico_btn"><span class="txt_gn11"><spring:message code='Cache.lbl_apv_comment' /></span> <span style="color: #dbdbdb;">I</span> <!-- 의견 -->
              	<img src="/approval/resources/images/Approval/ico_research_join.gif" alt="" title="<spring:message code='Cache.lbl_Modify' />" class="ico_btn"><span class="txt_gn11"><spring:message code='Cache.lbl_Modify' /></span> <!-- 수정 -->
        	</p>
        	<%
			}
			%>
...
<script>
	...
	function setGridConfig(){
		...
		if(g_mode == "Approval"){ //미결함 - 읽은 게시글은 style : font-weight를 사용하여 굵게 표시 하도록 분리
			 headerData =[	/// 결재 상세정보 표시 ////
			                  ...
			                  {key:'IsComment', label:' ',  width:'12', align:'center', sort:false, hideFilter:'Y',
			                	  formatter:function () {
			                  ...
			                  {key:'IsModify', label:' ', width:'12', align:'center', sort:false, hideFilter:'Y',
			                	  formatter:function () {
	...
	function DetailDisplay(pObj){
		if($("#DetailSearch").hasClass("active")){
			...
			// 검색조건 초기화
			$('#DetailSearch').find("input[type='text']").val("");
			$('#DetailSearch').find(".selList").each(function(idx,item){
