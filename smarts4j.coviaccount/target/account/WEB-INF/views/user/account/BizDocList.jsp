...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="egovframework.coviframework.util.DicHelper,
		...
		<div class="apprvalBottomCont">
			...
			<div class="btn_group bizdoc_wrap">
				...
				<div class="fRight">
					...
					<div class="selBox" style="min-width: 100px; margin-right: 5px;" id="selectGroupType"></div>
