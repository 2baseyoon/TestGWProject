...
public class BoardVManageImpl extends EgovAbstractServiceImpl implements BoardVManageSvc{
	...
	/**
	 * @param params
	 * @description 전체 폴더 기본 설정 조회
	 * @return CoviMap 
	 * @throws Exception
	 */
	@Override
	public CoviList selectAllBoardConfig(CoviMap params) throws Exception{
		CoviList result = new CoviList();
		result = coviMapperOne.list("admin.board.selectDefaultConfig", params);
		return result;
	}
	...
	public int updateBoardConfig(CoviMap params) throws Exception {
		...
		if(cnt > 0 && ("Y".equals(params.get("useUserProcess")) || "Y".equals(params.get("useOwnerProcess")))){
			//
