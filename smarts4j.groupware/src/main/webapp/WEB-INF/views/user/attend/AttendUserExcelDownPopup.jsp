<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="egovframework.baseframework.util.RedisDataUtil" %>
		...
		<div class="ATMgt_popup_wrap">
			<div class="ATMgt_work_wrap">
				<table class="ATMgt_popup_table type03" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td class="ATMgt_T_th"><spring:message code='Cache.lbl_att_workTime'/></span></td>
						<td>
							<%if (RedisDataUtil.getBaseConfig("ExcelDataMode").contains("A")){%>
							<input id="dataMode1" name="dataMode" value="" type="checkbox" checked>
							<label for=dataMode1><spring:message code="Cache.lbl_n_att_acknowledgedWork"/></label><!-- 인정 -->
							<%} %>
							<%if (RedisDataUtil.getBaseConfig("ExcelDataMode").contains("E")){%>
							<input id="dataMode2" name="dataMode" value="E" type="checkbox">
							<label for=dataMode2><spring:message code="Cache.lbl_n_att_AttRealTime"/></label><!-- 실근무 -->
							<%} %>
							<%if (RedisDataUtil.getBaseConfig("ExcelDataMode").contains("R")){%>
							<input id="dataMode3" name="dataMode" value="R" type="checkbox">
							<label for=dataMode3><spring:message code="Cache.lbl_entry_exit_records"/></label><!-- 입출입기록 -->
							<%} %>
							<%if ( (!RedisDataUtil.getBaseConfig("ExcelDataMode").contains("A")) &&  (!RedisDataUtil.getBaseConfig("ExcelDataMode").contains("E")) && (!RedisDataUtil.getBaseConfig("ExcelDataMode").contains("R")) ){%>
							<spring:message code="Cache.lbl_n_att_acknowledgedWork"/>
							<%} %>
						</td>
					</tr>
					<tr>
						...
						<td>							
							<div class="attendRawData">
								<spring:message code='Cache.lbl_AttendRawData'/>
							</div>
