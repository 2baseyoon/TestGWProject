<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
		 import="egovframework.baseframework.util.PropertiesUtil,egovframework.coviframework.util.RedisDataUtil" %>
					...
					<tr id="AssTr" class="divAss" style="display: none;">
						...
						<td>
							<div class="ATMgt_T_Time">
								...
								<select id="AssSeq" style="width:70%;" name="AssSeq" ${data.AssYn != null && data.AssYn == 'Y'?"":"disabled"}>
...
<script>
	...
	function saveSchedule() {
		...
		var objParams = {
			...
			, "WorkPointX": ($("#WorkZone").val() == '' || $("#WorkAddr").val() == '') ? '' : $("#WorkPointX").val()
			, "WorkPointY": ($("#WorkZone").val() == '' || $("#WorkAddr").val() == '') ? '' : $("#WorkPointY").val()
