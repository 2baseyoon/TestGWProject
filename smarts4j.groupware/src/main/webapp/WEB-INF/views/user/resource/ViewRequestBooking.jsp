...
<div class='cRContBottom mScrollVH resourceContanier resourceContainerScroll'>
	<div class="inPerView type03 ">
		<div>
			...
			<a id="searchDetailBtn" onclick="javascript: resourceUser.resource_MakeRequestList({ page: 'Y', header: 'Y', search: 'Y', mode: 'listOnly' });" class="btnTypeDefault btnSearchBlue "><spring:message code='Cache.btn_search' /></a><!-- 검색 -->
		</div>
		<div>
			<div class="selectCalView">
...
<!-- 						<button onclick="resourceUser.refresh();" class="btnRefresh" type="button"></button> -->
			...
			<div class="tblList tblCont">
				<div id="RequestListGrid" style="overflow-x: hidden; overflow-y: auto; height: auto;"></div>
			</div>
...
<script>
	...
	function initContent(){
		...
		resourceUser.resource_MakeRequestList({ page: 'Y', header: 'Y', mode: 'listOnly' });
	}
</script>