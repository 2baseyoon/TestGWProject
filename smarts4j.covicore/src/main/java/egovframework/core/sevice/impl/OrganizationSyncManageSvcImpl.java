...
public class OrganizationSyncManageSvcImpl extends EgovAbstractServiceImpl implements OrgSyncManageSvc {
	...
	public CoviMap syncTempObject() throws Exception {
		...
		String isHRInterface = RedisDataUtil.getBaseConfig("isHRInterface");
...
*/				
	...
	public CoviMap selectOrgExcelList(CoviMap params) throws Exception {
		...
		if (params.get("type").toString().equalsIgnoreCase("dept")) {
			...
			sField = "GroupCode,GroupName,SortKey,IsUse,Description,Type,MemberCode,MemberName,MemberMailAddress";
			list = coviMapperOne.list("organization.syncmanage.selectGroupMemberExcelList", params);
			cnt = (int) coviMapperOne.getNumber("organization.syncmanage.selectGroupMemberExcelListCnt", params);
		}
	...
	@Override
	public void deleteCompareObject(CoviMap params) throws Exception {
		coviMapperOne.delete("organization.syncmanage.deleteCompareObject_"+params.get("ObjectType") ,params);
	}
